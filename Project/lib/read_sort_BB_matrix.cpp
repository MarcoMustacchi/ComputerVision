...
std::vector<std::vector<int>> read_sort_BB_matrix(std::string file_name)
{
    ...
    //_________________________________ create a 2D vector that will store the read information _________________________________//
    ...
    //____________________________________________________ Sort rows by first column ____________________________________________________//
