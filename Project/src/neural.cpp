...
const char* classNames[] = { "all" };// According to the needs of this category 
...
int main() {
	...
	cv::Mat frame = cv::imread("../Dataset/rgb/" + image_number + ".jpg", cv::IMREAD_COLOR);
	...
	// String weights = "../model/best.pb";
	
	// String prototxt = "models\\ssd_inception_v2_coco_2017_11_17.pbtxt";
	
	dnn::Net net = cv::dnn::readNetFromTensorflow("../model/model.pb");
	...
	cv::Mat blob = cv::dnn::blobFromImage(frame, 1. / 255, Size(224, 224));
